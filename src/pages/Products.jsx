...
const Products = () => {
  ...
  const { data: allProducts, loading, error } = useFetch('https://6823578865ba058033965cb4.mockapi.io/kopireem/Kopi');
  ...
  return (
    <div className="products-page p-6">
      <h1 className="text-3xl font-bold mb-4"> Menu Kopi </h1>
